...
Public Class EditableComboBoxDisplay
    ...
    ' display settings.
    Protected Overrides Sub GetDisplayLayout(
     ByRef colorBoxRect As System.Drawing.Rectangle,
     ByRef textBoxRect As System.Drawing.RectangleF,
    ...
    Private Sub HandleUserEnteredColorName(ByVal name As String, ByVal validated As Boolean)
        Try
            ...
            Dim NewColor As Color = CType(ElaColorChooser.ColorTypeConverter.ConvertFrom(name), Color)
            ...
            If (Len(ElaColorChooser.ColorTypeConverter.ConvertToString(NewColor)) = 0) Then
                Beep()
            ...
            If TypeOf Me.Parent Is ElaColorChooser Then
                DirectCast(Me.Parent, ElaColorChooser).Color = NewColor
            End If
