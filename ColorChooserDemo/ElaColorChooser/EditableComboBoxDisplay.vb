...
Public Class EditableComboBoxDisplay
    ...
    Private Sub HandleUserEnteredColorName(ByVal name As String, ByVal validated As Boolean)
        Try
            ...
            Dim NewColor As Color = CType(ElaColorPicker.ColorTypeConverter.ConvertFrom(name), Color)
            ...
            If (Len(ElaColorPicker.ColorTypeConverter.ConvertToString(NewColor)) = 0) Then
                Beep()
            ...
            If TypeOf Me.Parent Is ElaColorPicker Then
                DirectCast(Me.Parent, ElaColorPicker).Color = NewColor
            End If
