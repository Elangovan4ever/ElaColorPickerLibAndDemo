...
Public Class ComboBoxDisplay
    ...
    Protected Overridable Sub GetDisplayLayout(
     ByRef colorBoxRect As Rectangle,
     ByRef textBoxRect As RectangleF,
     ByRef buttonRect As Rectangle)

        Const DistanceFromEdge As Integer = 2

        ' The button occupies the right portion.
        buttonRect = Rectangle.FromLTRB(
        ...
        Else
            ...
            colorBoxRect = Rectangle.FromLTRB(
             2 * DistanceFromEdge, 2 * DistanceFromEdge,
             CInt(1.5 * Me.DownButtonWidth),
             buttonRect.Bottom - DistanceFromEdge)

            ' The text occupies the middle portion.
            textBoxRect = RectangleF.FromLTRB(
             colorBoxRect.Right + DistanceFromEdge, DistanceFromEdge,
